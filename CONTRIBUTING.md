Contributing to Dunduck Core
============================

The Dunduck Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/Raptor3um/dunduck/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Dunduck Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Dunduck
Network Protocol consensus changes.

Whether a pull request is merged into Dunduck Core rests with the project merge
...
Patches that change Dunduck consensus rules are considerably more involved than
...
Where a patch set proposes to change the Dunduck consensus, it must have been
...
The review process is normally fairly responsive on the Dunduck Core repository, however
...
The project leader is the release manager for each Dunduck Core release.
