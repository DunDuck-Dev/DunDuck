...
* dunduck.conf: contains configuration settings for dunduckd or dunduck-qt
* dunduckd.pid: stores the process id of dunduckd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by dunduckd or dunduck-qt
