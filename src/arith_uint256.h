...
#ifndef DUNDUCK_ARITH_UINT256_H
#define DUNDUCK_ARITH_UINT256_H
...
public:
     ...
     *
     * Dunduck only uses this "compact" format for encoding difficulty
