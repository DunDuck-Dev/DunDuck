...
#error Client version information missing: version is not defined by dunduck-config.h or in any other way
#endif
...
/**
 * dunduckd-res.rc includes this file, but it cannot cope with real c++ code.
