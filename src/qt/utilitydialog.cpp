    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:\n"
            "  dunduck-qt [command-line options]                     \n";
...
All the Dunduck in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 DUN, 0.01 DUN, 0.1 DUN, 1 DUN and 10 DUN -- sort of like the paper money you use every day.</li> \
