...
"""Verify that starting dunduckd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start dunduckd with -h for help text")
        ...
        self.log.info("Start dunduckd with -version for version information")
