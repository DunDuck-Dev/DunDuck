...
from test_framework.test_framework import DunduckTestFramework
...
class LLMQChainLocksTest(DunduckTestFramework):
    def set_test_params(self):
        self.set_dunduck_test_params(6, 5, fast_dip3_enforcement=True)
