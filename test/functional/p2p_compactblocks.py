...
# TestP2PConn: A peer we use to send messages to dunduckd, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes dunduckd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that dunduckd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for dunduckd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # dunduckd will not send blocktxn responses for blocks whose height is
