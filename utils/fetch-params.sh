...
if [ "$uname_S" = "Darwin" ]; then
    PARAMS_DIR="$HOME/Library/Application Support/DunduckParams"
else
    PARAMS_DIR="$HOME/.dunduck-params"
fi
...
DOWNLOAD_URL="https://github.com/Raptor3um/dunduck/releases/tag/1.2.15.3"
...
Failed to fetch the Dunduck parameters!
...
This script will fetch the Dunduck SNARK parameters and verify their
...
EOF
    ...
    then
        ...
        cat >> "$README_PATH" <<EOF
This directory stores common Dunduck SNARK parameters. Note that it is
